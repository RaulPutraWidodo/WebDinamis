  ...
  <footer class="bg-dark text-white text-center py-3 mt-5">
    <div class="container">
      <div class="row">
        <div class="col-md-4">
          <h5>Kontak Saya</h5>
          <p>Email: ultra300405@gmail.com</p>
          <p>Telepon: 085782155837</p>
        </div>
        <div class="col-md-4">
          <h5>Ikuti Saya</h5>
          <p>jangan di ikuti nanti tersesat</p>
        ...
        <div class="col-md-4">
          <h5>Lokasi</h5>
          <p>Jl. Inspeksi Kalimalang Tegal Danas Arah DELTAMAS, Cikarang Pusat - Kab. Bekasi</p>
          <p>Indonesia</p>
        </div>
      </div>
